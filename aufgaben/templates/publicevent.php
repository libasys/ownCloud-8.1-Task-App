	...
	<?php
			...
			$calendar =OCA\Calendar\App::getCalendar($_['calendar'], false, false);
					...
					if(count($_['categories']) > 0 && $_['categories']!='' ) { 
					 ...
					 ?>	
		 			<a href="<?php print_unescaped(\OC::$server->getURLGenerator()->linkToRoute('calendar.export.exportEvents')) ?>?t=<?php p($_['token']); ?>" title="export as ics file"><i style="font-size:30px;" class="ioc ioc-download"></i></a> 
